...
export const gifs = [
  "/champlooJin.gif",
  "/champlooSamurai.gif",
  "/samuraiChamploo3.gif",
  "/samuraiChamploo2.gif",
  "/katana.gif",
  "/ruruni.gif",
];
...
export const testimonials = [
  {
    ...
    name: "Mehi Eddin",
    designation: "CEO of Coursfy",
    src: "/coursfy_logo.png",
  },
  {
    quote:
      "Collaborating with Anna was a pleasure. Her professionalism, promptness, and dedication to delivering exceptional front-end and web UI results were clear throughout our project. Anna’s enthusiasm for crafting intuitive, user-friendly interfaces stands out in every aspect. Her ability to focus on both design and functionality makes her an exceptional partner. If you're looking to elevate your website’s UI and overall user experience, Anna is the ideal collaborator, bringing unmatched skill, creativity, and attention to detail.",
    name: "Krzysztof Zielinski",
    designation: "Product Developer of Rotoy ApS",
    src: "/rotoy_logo.png",
  },
  {
    quote:
...
export const experiences = [
  {
    ...
    role: "Frontend-Focused Full-Stack Developer | Independent Projects",
    company: "Self-employed",
    logo: "",
  },
  {
    period: "Jul 2024 - Dec 2024",
    role: "Full-Stack Developer (Frontend-Focused) | Internship",
    company: "Coursfy",
  ...
  },
  {
    ...
    role: "Frontend Developer & Designer | Mandatory Internship (DCI Program)",
    company: "Rotoy ApS",
