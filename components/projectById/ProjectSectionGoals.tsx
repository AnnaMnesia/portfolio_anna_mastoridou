...
const ProjectSectionGoals = ({ project }: ProjectSectionGoalsProps) => {
  if (!project.section1) {
    return null;
  }
        ...
        <div className="relative p-4 mx-auto max-w-4xl">
          ...
          <div className="mt-6 flex gap-5 items-center">
            ...
            <div className="flex-col">
              ...
              {project.section1.bullets && (
                <ul className="mt-2 list-disc pl-4 space-y-1">
                  {project.section1.bullets.map((item, index) => (
                    <li
                      key={index}
...
export default ProjectSectionGoals;
