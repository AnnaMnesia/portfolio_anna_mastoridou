...
export const ImageCards = () => {
  ...
  return (
      <div className="flex w-full md:items-center items-center justify-center ">
        <div className={'flex w-full flex-wrap md:flex-row items-center justify-around '}>
          {images.map((image, idx) => (
            <motion.div
              variants={imageVariants}
              key={"images-first" + idx}
              style={{
                rotate: Math.random() * 35 - 10,
              }}
